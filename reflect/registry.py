# 详细说明见 docs/scripts/core/memory_v5/v5/reflect/registry.md
...
from memory_v5.reflect.scheduler import (  # noqa: E402
...
def make_consolidate_op() -> ReflectOp:
    """对话整合: 1h, 小模型提取 + 大模型验证."""
    from memory_v5.reflect import consolidate
...
def make_distill_op() -> ReflectOp:
    ...
    from memory_v5.reflect import distill
...
def make_reflection_promote_op() -> ReflectOp:
    ...
    """
    from memory_v5.reflections import auto_promote_stale
...
def make_expire_directives_op() -> ReflectOp:
    ...
    from memory_v5.user_directives import expire_old
