# 详细说明见 docs/scripts/core/memory_v5/v5/reflect/llm_client.md
...
# 内联说明见 docs/scripts/core/memory_v5/v5/reflect/llm_client.md（见“内联注释摘录”）
...
# 根 = 本文件位置推导 (core/memory_v5/reflect/ → 项目根), 不写死盘符
try:
    from dotenv import load_dotenv
    _ikaros_root = os.environ.get("IKAROS_ROOT", "")
    if not _ikaros_root:
        _ikaros_root = str(V4_ROOT.parent.parent.parent)  # core/memory_v5/reflect → 项目根
