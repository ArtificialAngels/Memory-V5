...
logger = logging.getLogger("memory_v5.extensions.tree_adapter")
...
# ───────────────────────────────────────────────────────────────────────────
# 1) core/memory_v5/conversation_tree.py :: add_turn (约 L572)
...
#
# 2) core/memory_v5/conversation_tree.py :: MemoryRetriever.add_memory (约 L1118)
