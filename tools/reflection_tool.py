...
def v5_reflection_synthesize(content: str, character: str = "",
    ...
    """
    from memory_v5.reflections import synthesize
    try:
...
def v5_reflection_read(character: str = "", status: str = "",
    ...
    """
    from memory_v5.reflections import read
...
def v5_reflection_apply_evidence(reflection_id: str, character: str = "",
    ...
    Returns:
        "ok" or error message
    """
    from memory_v5.reflections import apply_evidence
...
def v5_reflection_promote(reflection_id: str, character: str = "") -> str:
    ...
    Returns:
        "ok" or error message
    """
    from memory_v5.reflections import promote_to_persona
...
def v5_reflection_stats(character: str = "") -> str:
    ...
    Returns:
        JSON stats dict
    """
    from memory_v5.reflections import stats
