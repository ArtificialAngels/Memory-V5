# 详细说明见 docs/scripts/core/memory_v5/v5/tools/extra_tool.md

from __future__ import annotations

from memory_v5.tools.utils import safe_tool, dumps
...
def v5_proactive_check() -> str:
    ...
    """
    from memory_v5.proactive import should_speak, try_proactive
...
def v5_self_discover() -> str:
    ...
    """
    from memory_v5.self_discovery import self_discover
    n = self_discover()
...
def v5_context_compression_stats() -> str:
    ...
    import cogno_5d
    from memory_v5.rhythm import build_rhythm_block, last_interaction_ts
    from memory_v5.summary import _load_cache as _load_summary_cache
    from memory_v5.profile import load_dislikes, load_preferences
