...
class TestEmotionalMemory:
    ...
    def test_delta_above_threshold_smoke(self):
        ...
        from memory_v5.emotional_memory import _rule_based_causal
...
class TestDissonance:
    ...
    def test_check_types_defined(self):
        """验证检查类型白名单导入不崩溃."""
        from memory_v5.dissonance import _CHECK_TYPES
...
class TestNarrative:
    ...
    def test_simple_narrative_no_crash(self):
        from memory_v5.narrative import _simple_narrative
