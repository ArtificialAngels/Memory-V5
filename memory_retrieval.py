# 详细说明见 docs/scripts/core/memory_v5/v5/memory_retrieval.md
...
def _score_items(
    ...
    *,
    ...
    for item in merged.values():
        ...
        try:
            from memory_v5.importance import effective_importance as _ei_fn
...
def retrieve(
    ...
    *,
    ...
    if bool(sit_cfg.get("enabled", True)) and (
        ...
        try:
            from memory_v5.context_anchor import now_context
            sit_ctx = now_context()
...
def _graph_retrieve(query: str, tk: int, graph_min: float = 0.0) -> list[dict]:
    ...
    out: dict[str, dict] = {}
    try:
        from memory_v5.search import entity_graph_search
    ...
    try:
        from memory_v5.project_edges import project_graph_search
